...
A FastTracker II clone built from scratch for fun.

![CMake](https://github.com/erikalds/mt/workflows/CMake/badge.svg)


## Build Instructions

These build instructions are left over from cpp_starter_project.
